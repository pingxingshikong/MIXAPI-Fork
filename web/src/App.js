...
import UsageStatisticsMonthly from './pages/UsageStatisticsMonthly';
  ...
  return (
    <SetupCheck>
      <Routes>
        ...
        />
        <Route
          path='/console/usage-statistics-monthly'
          element={
            <PrivateRoute>
              <UsageStatisticsMonthly />
            </PrivateRoute>
          }
        />
        <Route
