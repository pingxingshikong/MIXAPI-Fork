...
const UsageStatisticsTable = () => {
  ...
  const [compactMode, setCompactMode] = useTableCompactMode('usage_statistics');
  ...
  const loadStatistics = async (page = 1, size = pageSize, searchParams = {}) => {
    ...
    try {
      ...
      const apiEndpoint = isAdmin() 
        ...
        : `/api/usage_statistics/self?${params}`;
...
export default UsageStatisticsTable;