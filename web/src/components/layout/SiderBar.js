...
const routerMap = {
  ...
  user: '/console/user',
  log: '/console/log',
  'usage-statistics': '/console/usage-statistics',
  'usage-statistics-monthly': '/console/usage-statistics-monthly',
...
const SiderBar = ({ onNavigate = () => { } }) => {
  ...
  const workspaceItems = useMemo(
    () => [
      ...
      {
        text: t('用量日统计'),
        itemKey: 'usage-statistics',
        to: '/usage-statistics',
      },
      {
        text: t('用量月统计'),
        itemKey: 'usage-statistics-monthly',
        to: '/usage-statistics-monthly',
      },
      {
        text: t('绘图日志'),
        itemKey: 'midjourney',
  ...
  const getItemColor = (itemKey) => {
    switch (itemKey) {
      ...
      case 'usage-statistics': return sidebarIconColors.barChart;
      case 'usage-statistics-monthly': return sidebarIconColors.barChart;
